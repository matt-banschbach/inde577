...
class DecisionTree:
    ...
    def __init__(self, max_depth=4, min_samples_leaf=1,
        ...
        :param min_samples_leaf: (int) -> min # of samples required to be in a leaf to make the splitting possible
        :param min_information_gain: (float) -> min information gain required to make the splitting possible
        :param numb_of_features_splitting: (str) ->  when splitting if sqrt then sqrt(# of features) features considered,
                                                            if log then log(# of features) features considered
                                                            else all features are considered
        :param amount_of_say: (float) -> used for Adaboost algorithm
        """
